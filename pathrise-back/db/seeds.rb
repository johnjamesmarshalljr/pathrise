...
response = File.read("./public/jobBoards.json")
...
CSV.foreach('./lib/job_opportunities.csv', skip_blanks: true, nil_value: " ", empty_value: ' ', headers: true, :converters => [:all], :header_converters => [:downcase]) do |row|
