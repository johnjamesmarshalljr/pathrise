...
class OpportunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post opportunities_url, params: { opportunity: { company: @opportunity.company, source: @opportunity.source, title: @opportunity.title, url: @opportunity.url } }
    end
  ...
  test "should update opportunity" do
    patch opportunity_url(@opportunity), params: { opportunity: { company: @opportunity.company, source: @opportunity.source, title: @opportunity.title, url: @opportunity.url } }
